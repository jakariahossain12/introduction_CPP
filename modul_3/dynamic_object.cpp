...
// this function work because it is a dynamic object and dynamic object not remove the after run 
// this function work because it store heap memory 
Student* dynamic(){
    char n[100] = "rarib";
    Student* ra =new Student(n,23,2.33,2);
    return ra;
...
//?! ==================== dynamic object ========
    ...
    char s[100] = "sakib";
    Student* sa = new Student(s,23,2.33,2);
    cout<< sa->name<<endl ;
    
    Student* dyna = dynamic();
    cout<< dyna->name ;
